/* [project]/node_modules/@waline/client/dist/waline.css [app-client] (css) */
:root {
  ...
  --waline-warning-color: #915930;
  --waline-warning-bg-color: #eab30824;
  --waline-bq-color: #f0f0f0;
  --waline-avatar-size: 3.25rem;
  --waline-m-avatar-size: calc(var(--waline-avatar-size) * 9 / 13);
  --waline-badge-color: #3498db;
  --waline-badge-font-size: .75em;
...
.wl-cards .wl-user .verified-icon, .wl-cards .wl-user .administrator-icon {
...
.wl-card .wl-delete, .wl-card .wl-like, .wl-card .wl-reply, .wl-card .wl-edit, .wl-card .wl-rss {
  color: var(--waline-color);
  cursor: pointer;
  background: none;
  border: none;
...
.wl-card .wl-delete:hover, .wl-card .wl-like:hover, .wl-card .wl-reply:hover, .wl-card .wl-edit:hover, .wl-card .wl-rss:hover {
  color: var(--waline-theme-color);
}

.wl-card .wl-delete.active, .wl-card .wl-like.active, .wl-card .wl-reply.active, .wl-card .wl-edit.active, .wl-card .wl-rss.active {
  color: var(--waline-active-color);
}

.wl-card .wl-warning {
  border: 1px dashed var(--waline-warning-color);
  background: var(--waline-warning-bg-color);
  color: var(--waline-warning-color);
  border-radius: 5px;
  margin-top: 1em;
  padding: .5em 1em;
  font-size: .875em;
...
.wl-card .wl-content.expand:before {
  ...
  z-index: 999;
  background: linear-gradient(#000, #ffffffe6);
  width: 100%;
  display: block;
  position: absolute;
  top: 0;
...
.wl-card .wl-quote {
  border-inline-start: 1px dashed #ededed80;
}
...
.wl-star-outline {
  fill: none;
  stroke: var(--waline-light-grey);
  stroke-width: 1.5px;
}

.wl-star-solid {
  fill: var(--waline-theme-color);
...
.wl-star-row .wl-star-rate {
  align-items: center;
  gap: 3px;
}

.wl-star-row .wl-star-item {
  width: 12px;
  height: 12px;
  display: flex;
}
...
.wl-user-list .wl-user-item:first-child .wl-user-badge {
...
/*# sourceMappingURL=node_modules_%40waline_client_dist_waline_0yvqa6y.css.map*/